...
- Cognito Authentication (multi-group, custom attributes)  
- EC2, Lambda, API Gateway, DynamoDB, S3, CloudWatch  
- Infrastructure automation (CDK, CloudFormation, Amplify)  
- CI/CD pipelines (GitHub Actions → EC2/Amplify/Vercel)
